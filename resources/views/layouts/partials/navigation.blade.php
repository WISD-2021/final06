...
<!-- Navigation -->
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav" style="background: #FF8560">
    <div class="container">
        <a class="navbar-brand" href="{{route('dashboard')}}"><img src="{{asset('images/ann.png')}}" height="40px" width="40px" ></a>
        <a class="navbar-brand" href="{{route('dashboard')}}"><font style="font-family:標楷體;margin:-50px;">安醬油</font></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('dashboard')}}#about">醬油介紹</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('dashboard')}}#services">購買商品</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('dashboard')}}#appointment">課程預約</a>
                </li>
                <li class="nav-item">
